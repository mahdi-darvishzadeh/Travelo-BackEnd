...
if DEBUG_DB:
    ...
    DATABASES = {
        "default": {
            ...
            "NAME": config("DB_NAME", default="Travelo_db"),
            "USER": config("DB_USER", default="postgres"),
            "PASSWORD": config("DB_PASS", default="hZmoVFq0irs3gFowHpyO2coID8da2Oer"),
            "HOST": config("DB_HOST", default="travelo-dev-postgresql"),
...
# messages configuration for notification handling in pages
MESSAGE_TAGS = {
    messages.DEBUG: "info",
    messages.INFO: "info",
